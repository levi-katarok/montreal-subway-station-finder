// ============================================================================
// TYPE DEFINITIONS - Montreal Bike Route Assistant
// ============================================================================
...
export interface WeatherData {
  ...
  airQuality?: number; // US EPA index (1-6)
  airQualityLabel?: string; // Good, Moderate, etc.
  timestamp: number;
}
...
export interface BikeRoute {
  ...
  distance: number; // meters
  duration: number; // seconds
  estimatedTotalTime?: number; // seconds (for round trip or with stops)
  ...
  trafficLevel: TrafficLevel;
  airQualityScore: number; // 1-10 scale
